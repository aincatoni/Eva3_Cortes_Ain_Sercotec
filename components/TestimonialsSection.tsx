...
export function TestimonialsSection({testimonials}: TestimonialsSectionProps) {
  return (
    <section id='testimonios' className='scroll-mt-28 space-y-6 rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_26px_90px_rgba(15,23,42,0.08)] lg:p-10'>
